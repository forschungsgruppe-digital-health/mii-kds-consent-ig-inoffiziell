...
* **[Data Sets and Descriptions](logical-models.md)** — the module's data elements, described as logical models. (This entry shares its target with **Artifacts → Logical Models**; none of the anchors of the artifact overview can be used as a link target — see [`docs/page-structure.md`](https://github.com/forschungsgruppe-digital-health/mii-kds-consent-ig-inoffiziell/blob/main/docs/page-structure.md) in this repository.)
