# Versioning - MII Implementation Guide Consent v2026.0.1
...
The **Consent** module follows the MII calendar-versioning (CalVer) scheme in a SemVer-compatible numeric form:
