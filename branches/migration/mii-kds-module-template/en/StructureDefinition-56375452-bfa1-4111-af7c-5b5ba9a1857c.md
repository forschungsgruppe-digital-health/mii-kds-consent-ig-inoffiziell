# Profile - MI-I - Consent - DocumentReference - MII Implementation Guide Consent v2026.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-consent/StructureDefinition/mii-pr-consent-documentreference | *Version*:2026.0.1 |
...
Building on the [recommendations](https://ig.fhir.de/einwilligungsmanagement/stable/DocumentReference.html) of the AG Einwilligungsmanagement, the profile **MII_PR_Consent_DocumentReference** targets the representation of scanned consent documents — restricted to scans of consent documents in PDF format.
