...
Building on the
[recommendations](https://ig.fhir.de/einwilligungsmanagement/stable/Provenance.html)
of the AG Einwilligungsmanagement, the profile *MII\_PR\_Consent\_Provenance*
describes the origin of the consent content — the signatures above all — and
links it to the persons involved.
