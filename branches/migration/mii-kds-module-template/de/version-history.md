# Versionierung - MII Implementation Guide Consent v2026.0.1
...
Das Modul **Consent** folgt dem MII-Schema der Kalender-Versionierung (CalVer) in einer SemVer-kompatiblen numerischen Form:
