# Umgang mit fehlenden Daten - MII Implementation Guide Consent v2026.0.1
...
> **TODO:REVIEW — DOKUMENTIERTE LÜCKE, NICHT GEFÜLLT.** Der publizierte Leitfaden enthält keinen Abschnitt zum Umgang mit fehlenden Daten. Diese Seite trägt daher weiterhin den Starttext des Modul-Templates. Gate B entscheidet, ob der Abschnitt geschrieben oder die Seite aus dem Leitfaden genommen wird. Siehe die Lückentabelle des Migrationsberichts.
...
Diese Seite legt fest, wie ein konformes System solche Fälle in den Ressourcen des Moduls **Consent** darstellt. Die Regeln stimmen mit der [FHIR-Kernspezifikation](https://hl7.org/fhir/R4/extensibility.html#Special-Case) überein und sind konsistent mit der internationalen Praxis, wie sie die [International Patient Summary (IPS)](https://hl7.org/fhir/uv/ips/Empty-Sections-and-Missing-Data.html) definiert.
