...
| Metrik | source-package-2026.0.0 | migrated | Σ Gesamt |
|---|---|---|---|
| Artefakte gesamt | 15 | 20 | 35 |
| Profile | 3 | 3 | 6 |
| ValueSets | 3 | 3 | 6 |
| CodeSystems | 3 | 3 | 6 |
| Beispiele | 0 | 5 | 5 |
| Narrative-Inhalts-Seiten | 0 | 22 | 22 |
| Wörter gesamt | 0 | 11513 | 11513 |
| Plattform-Direktiven | 0 | 0 | 0 |
| Doppelte Inhaltsblöcke | 0 | 2 | 2 |
| Nicht referenzierte Bilder | 0 | 0 | 0 |
| Dependencies (floating) | 0 (0) | 2 (0) | — |
| Ø Wörter / Seite | 0 | 523,3 | — |
| Median Wörter / Seite | 0 | 289 | — |
| Hersteller-Lock-in /100 | 0 | 0 | — |
| Standard-Terminologie % | 0 | 98 | — |
...
| Metrik | source-package-2026.0.0 | migrated |
|---|---|---|
| Direktiven je Seite | 0 | 0.0 |
| Beispiele je Profil | 0.0 | 1.67 |
...
quadrantChart
    ...
    "source-package-2026.0.0": [0.75, 0.0]
    "migrated": [1.0, 0.0]
```
