<!-- Harvested from https://simplifier.net/guide/miiigmodulconsent/MIIIGModulConsent/AnwendungsflleInformationsmodell?version=2026.0.0 on 2026-08-06 by scripts/guide-harvest.sh (spec 5.1d). -->
