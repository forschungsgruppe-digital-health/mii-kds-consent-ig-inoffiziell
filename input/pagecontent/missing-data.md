...
> **TODO:REVIEW — RECORDED GAP, NOT FILLED.** The published guide contains no section on handling missing data.
> This page therefore still carries the module template's starter text.
> Gate B decides whether to write the section or to keep the page out of
> the guide. See the migration report's gap table.
...
**Consent** module's resources. The rules follow the
