...
{:.bg-info}
**Migration note (2026-08-06):** the source guide has no metadata page; this page describes
this repository's CRMI metadata. The `[TODO ...]` prompts below are **template setup items for
the module owners**, not missing narrative.
